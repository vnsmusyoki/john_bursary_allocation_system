        ...
        <div class="leftside-menu">
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                ...
                <ul class="side-nav">
                    ...
                    <li class="side-nav-item">
                        <a data-bs-toggle="collapse" href="#sidebarcalendars" aria-expanded="false"
                            aria-controls="sidebarcalendars" class="side-nav-link">
                            <i class="bi bi-calendar3"></i>
                            <span> Calendar </span>
                            <span class="menu-arrow"><i class="bi bi-chevron-right "></i></span>
                        </a>
                        <div class="collapse" id="sidebarcalendars">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="apps-projects-list.html">List</a>
                                </li>
