...
<head>
    ...
    <title>Home 02 || Eduhas - Education Bootstrap 5 Template</title>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="top-contact-info">
                            <ul>
                                <li><a href="tel:012345676"><i class="zmdi zmdi-phone"></i> +98 558 547 589</a></li>
                                <li><a href="mailto:education@ingo.com"><i class="zmdi zmdi-email"></i> education@info.com</a></li>
                            </ul>
                                    ...
                                    <ul>
                                        <li class="active"><a href="{{ url('/') }}"> HOME</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li><a href="index-box-2.html">Home Box layout 2</a></li>
                                            </ul>
                                        </li>
                                        ...
                                        <ul>
                                            ...
                                            <li class="single-item">
                                                <div class="product-img">
                                                    <a href="#"><img src="assets/images/other/cart-01.jpg" alt=""></a>
                                                </div>
                                            ...
                                            <li class="single-item">
                                                <div class="product-img">
                                                    <a href="#"><img src="assets/images/other/cart-02.jpg" alt=""></a>
                                                </div>
                                                <div class="product-info">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="slider-text-info">
                                    <h1><span>Modern Education </span> <br> For Everyone </h1>
                                    <a href="about.html" class="btn slider-btn uppercase"><span>About us</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="item-inner">
                                    <div class="cours-icon">
                                        <span class="coure-icon-inner">
                                            <img src="assets/images/icon/cat-01.png" alt="">
                                        </span>
                                    </div>
                                    <div class="cours-title">
                                        <h4>Apply Online</h4>
                                        <p>Contrary to popular
                                            Ipsum isnotimply random text.
                                            It assiLatin littfrom 45 BC,</p>
                                    </div>
                                </div>
                        ...
                        <div class="coustom-col-3">
                            ...
                            <div class="single-course-categories-two sunglow  wow fadeInBottom" >
                                <div class="item-inner">
                                    <div class="cours-icon">
                                        <span class="coure-icon-inner">
                                            <img src="assets/images/icon/cat-02.png" alt="">
                                        </span>
                                    </div>
                                    <div class="cours-title">
                        ...
                        <div class="coustom-col-3">
                            ...
                            <div class="single-course-categories-two mariner  wow fadeInBottom" >
                                <div class="item-inner">
                                    <div class="cours-icon">
                                        <span class="coure-icon-inner">
                                            <img src="assets/images/icon/cat-03.png" alt="">
                                        </span>
                                    </div>
                                    <div class="cours-title">
                                        <h4>Certification</h4>
                        ...
                        <div class="coustom-col-3">
                            ...
                            <div class="single-course-categories-two brilliantrose  wow fadeInBottom" >
                                <div class="item-inner">
                                    <div class="cours-icon">
                                        <span class="coure-icon-inner">
                                            <img src="assets/images/icon/cat-04.png" alt="">
                                        </span>
                                    </div>
                                    <div class="cours-title">
                ...
                <div class="col-lg-8 m-auto">
                    <div class="section-title-three mb--80">
                        ...
                        <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots
                         in a pi classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock,</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="provider-wrap">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                               ...
                               <div class="single-provide">
                                    ...
                                    <div class="single-provide-contented">
                                       <h4>Best Teacher</h4>
                                       <p>Contrary to popular belief, Loremsum isnotimply random text. It has roots </p>
                                    </div>
                               </div><!--// single-provide -->
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                               ...
                               <div class="single-provide">
                                    <div class="single-provide-icons">
                                        <img src="assets/images/icon/provide-02.png" alt="">
                                    </div>
                                    <div class="single-provide-contented">
                                       <h4>Best Lab</h4>
                                       <p>Contrary to popular belief, Loremsum isnotimply random text. It has roots </p>
                            ...
                            <div class="col-lg-6 col-md-6">
                               ...
                               <div class="single-provide">
                                    <div class="single-provide-icons">
                                        <img src="assets/images/icon/provide-03.png" alt="">
                                    </div>
                                    <div class="single-provide-contented">
                            ...
                            <div class="col-lg-6 col-md-6">
                               ...
                               <div class="single-provide">
                                    <div class="single-provide-icons">
                                        <img src="assets/images/icon/provide-04.png" alt="">
                                    </div>
                                    <div class="single-provide-contented">
    ...
    <div class="welcome-about-us">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12">
                    <div class="section-title-three section-inner-ptb text-left text-white">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incDuis aute irure dolor in reprehenderit in velit esse cillum dolore eu fugiat nulla pariatur.
                        Excepteur sint occaecat cupidatat non proident, sunt in omnis iste natus error sit voluptatem accusantiu.</p>
                        <div class="start-now">
                            <a href="#" class="start-btn">Start learn now</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="welcome-video">
            <div class="video-inner">
                <a href="https://www.youtube.com/watch?v=mgmepMoce1E" class="popup-youtube"><img src="assets/images/icon/video-icon.png" alt=""></a>
            </div>
        </div>
    </div>
    <!--// Welcome About Us -->
                    ...
                    <div class="col-12">
                        <div class="tabs-categorys-list">
                            <ul class="nav justify-content-center" role="tablist">
                               <li class="active"><a class="active" href="#graphic" role="tab" data-bs-toggle="tab">GRAPHIC DESIGN</a></li>
                               <li><a href="#interior"  role="tab" data-bs-toggle="tab"> INTERIOR DESIGN </a></li>
                               <li><a href="#animation"  role="tab" data-bs-toggle="tab"> ANIMATION</a></li>
                               <li><a href="#design" role="tab" data-bs-toggle="tab"> WEB DESIGN</a></li>
                           </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="courses-tab-active owl-carousel">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-popular-courses mt--30">
                                            <div class="popular-courses-image">
                                                <a href="#"><img src="assets/images/courses/courses-08.jpg" alt=""></a>
                                            </div>
                                            <div class="popular-courses-contnet">
                                                <h5>Combined with a Handful.</h5>
                                                <div class="post_meta">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-popular-courses mt--30">
                                            <div class="popular-courses-image">
                                                <a href="#"><img src="assets/images/courses/courses-07.jpg" alt=""></a>
                                            </div>
                                            <div class="popular-courses-contnet">
                                                <h5>Combined with a Handful.</h5>
                                                <div class="post_meta">
                            ...
                            <div class="row">
                                <div class="courses-tab-active owl-carousel">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-popular-courses mt--30">
                                            <div class="popular-courses-image">
                                                <a href="#"><img src="assets/images/courses/courses-09.jpg" alt=""></a>
                                            </div>
                                            <div class="popular-courses-contnet">
                                                <h5>Combined with a Handful.</h5>
                                                <div class="post_meta">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="all-course-btn">
                                <a href="course-grid.html" class="all-course">VIEW all</a>
                            </div>
                        </div>
                    </div>
    ...
    <div class="project-count-area section-ptb-160 project-count-bg">
        <div class="container">
            ...
            <div class="project-count-inner_one">
                <div class="row">
                    <div class="col-lg-10m-auto">
                        <div class="row">
                            <div class="col-lg-3 col-sm-6">
                                <!-- counter start -->
                                <div class="counter text-center">
                                    <h3 class="counter-active">50</h3>
                                    <p>Teacher</p>
                                </div>
                                <!-- counter end -->
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <!-- counter start -->
                                <div class="counter text-center">
                                    <h3 class="counter-active">160</h3>
                                    <p>Members</p>
                                </div>
                                <!-- counter end -->
                            </div>
            ...
            <div class="row">
                <div class="col-lg-4  col-md-6 col-12">
                    ...
                    <div class="single-our-blog mt--30">
                        ...
                        <div class="our-blog-contnet">
                            <h5><a href="blog-details.html">Fugiat nulla Pariatur All.</a></h5>
                            <div class="post_meta">
                                <ul>
                                    <li><p>By: <a href="#">Sekh Rana</a></p></li>
                                    <li><p>15 Fab 2020</p></li>
                                </ul>
                            </div>
                            <p>Contrary to popular belief, Lor isnotimply random text. Duis aute irure
                            d rehenderit in voluptate velit esse..</p>
                            <div class="button-block">
                ...
                <div class="col-lg-4  col-md-6 col-12">
                    ...
                    <div class="single-our-blog mt--30">
                        ...
                        <div class="our-blog-contnet">
                            <h5><a href="blog-details.html">Chunk of Lorem Ipsum used.</a></h5>
                            <div class="post_meta">
                                <ul>
                                    <li><p>By: <a href="#">Yasin Sekh</a></p></li>
                                    <li><p>22 Fab 2020</p></li>
                                </ul>
                            </div>
                            <p>Contrary to popular belief, Lor isnotimply random text. Duis aute irure
                            d rehenderit in voluptate velit esse..</p>
                ...
                <div class="col-lg-4  col-md-6 col-12">
                    ...
                    <div class="single-our-blog mt--30">
                        ...
                        <div class="our-blog-contnet">
                            <h5><a href="blog-details.html">The word in classical literat.</a></h5>
                            <div class="post_meta">
                                <ul>
                                    <li><p>By: <a href="#">Rehan Khan</a></p></li>
                ...
                <div class="col-lg-12">
                    <div class="all-course-btn">
                        <a href="#" class="all-course">all blog</a>
                    </div>
                </div>
            </div>
        </div>
