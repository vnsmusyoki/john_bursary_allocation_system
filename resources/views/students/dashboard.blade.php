            ...
            <div class="card-body">
                ...
                <div class="text-start">
                    ...
                    <p class="text-muted"><strong>Mobile :</strong><span
                            class="ms-2">(+12) 123 1234 567</span></p>
                    ...
                    <p class="text-muted mb-0" id="tooltip-container"><strong>Elsewhere :</strong>
                        <a class="d-inline-block ms-2 text-muted"
                            data-bs-container="#tooltip-container" data-bs-placement="top"
                        ...
                        <a class="d-inline-block ms-2 text-muted"
                            data-bs-container="#tooltip-container" data-bs-placement="top"
                            data-bs-toggle="tooltip" href="" title="Skype"><i
            ...
            <div class="col-sm-4">
                <div class="card tilebox-one">
                    <div class="card-body">
                        ...
                        <span class="badge bg-primary"> +11% </span> <span
            ...
            <div class="col-sm-4">
                <div class="card tilebox-one">
                    <div class="card-body">
                        ...
                        <span class="badge bg-primary"> +89% </span> <span
