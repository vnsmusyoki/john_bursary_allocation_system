...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/custom-student.css') }}">
...
<body class="loading"
    ...
    <div class="wrapper">
        ...
        <div class="leftside-menu">
            ...
            <!-- LOGO -->
            <a href="{{ route('student') }}" class="logo text-center logo-light">
                <span class="logo-lg">
            ...
            <!-- LOGO -->
            <a href="{{ route('student') }}" class="logo text-center logo-dark">
                <span class="logo-lg">
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                ...
                <ul class="side-nav">
                    ...
                    <li class="side-nav-item">
                        <a data-bs-toggle="collapse" href="{{ route('student') }}" aria-expanded="false"
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarTeachers">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="{{ url('student/feestatement') }}">Fee Statement</a>
                                </li>
                                <li>
                                    <a href="apps-ecommerce-products-details.html">Receipts</a>
                                </li>
                                <li>
                                    <a href="apps-ecommerce-products-details.html">Pay Fees</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarStudents">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="{{ route('managestudents.index') }}">Perfomance Analysis</a>
                                </li>
                                <li>
                                    <a href="{{ route('managestudents.index') }}">Results</a>
                                </li>
                                <li>
                                    <a href="">Exam Timetable</a>
                                </li>
                                <li>
                                    <a href="">Teaching Timetable</a>
                                </li>
                                <li>
                                    <a href="">Special Meetings</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarParents">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="apps-projects-list.html">Guardian Profile</a>
                                </li>
                            </ul>
                        </div>
                    </li>
