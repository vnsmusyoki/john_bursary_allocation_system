                ...
                <div class="tab-pane show active" id="floating-preview">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-select" id="floatingSelect22" wire:model="student_helb_status"
                                    aria-label="Floating label select example">
                                    <option>Click to select</option>
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-select" id="floatingSelectbursary" wire:model="financial_assistance"
                                    aria-label="Floating label select example" multiple style="height: 200px">
                                    <option>Click to select</option>
                                    <option value="High School Bursary">High School Bursary</option>
                                    <option value="Ministry of Education Bursary">Ministry of Education Bursary</option>
                                    <option value="Community Based Organization Support">Community Based Organization
                                        Support</option>
                                    <option value="Faith Based Organization Support">Faith Based Organization Support
                                    </option>
                                    <option value="Children's Home or Orphanage Support">Children's Home or Orphanage
                                        Support</option>
                                </select>
                                <label for="floatingSelectbursary">Tick Against financial assistance ever received.</label>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-floating mb-3">
                                <select class="form-select" id="floatingSelectfamily" wire:model="family_status"
                                    ...
                                    <option value="Separated or Divorced Parent">Separated or Divorced Parent</option>
                                </select>
                                <label for="floatingSelectfamily">Select Family Status</label>
                            </div>
                            <div class="form-floating mb-3">
                                <select class="form-select" id="floatingSelectspecialneeds" wire:model="special_needs"
                                    aria-label="Floating label select example">
                                    <option value="">Click to select</option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-select" id="floatingSelectneedsdesc"
                                    wire:model="special_needs_description" aria-label="Floating label select example">
                                    <option value="">Click to select</option>
                                ...
                                <label for="floatingSelectneedsdesc">If Yes,please select accordingly and attach relevant
                                    documents.</label>
                            </div>
                            <div class="form-floating mb-3">
                                <select class="form-select" id="floatingSelectincomeloss" wire:model="family_income_loss"
                                    aria-label="Floating label select example">
                                    <option>Click to select</option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                                <label for="floatingSelectincomeloss">has your Family experienced loss of income?.</label>
                            </div>
                            <div class="form-floating mb-3">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-floating mb-3">
                                ...
                                <label for="floatingPasswordattachfee">Fee structure.. Attach pdf documents only</label>
                            </div>
                            <div class="form-floating mb-3">
                                ...
                                <label for="floatingPasswordattachgrade">Last School Perfomance..attach pdf only</label>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-floating mb-3">
                        ...
                        <div class="col-lg-12">
                            <div class="form-floating mb-3">
                                ...
                                <label for="floatingTextareasupport">Use the space below to provide any other information that
