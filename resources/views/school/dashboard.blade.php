            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card widget-flat">
                        <div class="card-body">
                            <div class="float-end">
                                <img src="{{ asset('assets/images/reading-book.svg') }}" class="img-fluid widget-icon" alt="">
                            </div>
                            <h5 class="text-muted fw-normal mt-0" title="Number of Students">Students
                            </h5>
                ...
                <div class="col-lg-6">
                    <div class="card widget-flat">
                        <div class="card-body">
                            ...
                            <h5 class="text-muted fw-normal mt-0" title="Average Revenue">Parents</h5>
                    ...
                    <div class="card widget-flat">
                        <div class="card-body">
                            <div class="float-end">
                                ...
                                <h5 class="text-muted fw-normal mt-0" title="Growth">Support Staff</h5>
                            ...
                            <div class="timeline-alt pb-0">
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-item-info">
                                        <a href="#" class="text-info fw-bold mb-1 d-block">You sold an
                                            item</a>
